...
const editCandidateAvailabilitySchema = z
  .object({
    timezone: z
      .string({
    ...
    expectedRevision: z
      ...
      .nonnegative("expectedRevision must be a non-negative integer"),
  })
  .strict();

const validateEditCandidateAvailability = (request, _response, next) => {
  const parsed = editCandidateAvailabilitySchema.safeParse(request.body ?? {});
...
export default validateEditCandidateAvailability;
