...
const unassignApplicationSchema = z
  .object({
...
const validateUnassignApplication = (request, _response, next) => {
  const parsed = unassignApplicationSchema.safeParse(request.body ?? {});
...
export default validateUnassignApplication;
