...
const forceReassignApplicationSchema = z
  .object({
...
const validateForceReassignApplication = (request, _response, next) => {
  const parsed = forceReassignApplicationSchema.safeParse(request.body ?? {});
...
export default validateForceReassignApplication;
